...
const KarmaSortModel = ({ doNotClose, close, sortBy, setSortBy }) => {
  return (
    <KarmaSortModelStyled ref={doNotClose}>
    ...
    </KarmaSortModelStyled>
  );
};

export default KarmaSortModel;
...
const KarmaSortModelStyled = styled.div`
  position: absolute;
  bottom: 0;
  left: 0;
  z-index: 5;
