...
const KarmaFilterModel = ({ doNotClose, close, isFetching, filters, onUpdateFilters, savingFilter }) => {
  ...
  return (
    <KarmaFilterModelStyled ref={doNotClose}>
    ...
    </KarmaFilterModelStyled>
  );
};

export default KarmaFilterModel;
...
const KarmaFilterModelStyled = styled.div`
  position: absolute;
  bottom: 0;
  left: 0;
  z-index: 5;
