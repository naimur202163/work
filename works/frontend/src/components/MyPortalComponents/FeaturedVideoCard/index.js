...
const FeaturedVideoCard = ({ nousername, video, noAvatar, showLocation = true, showDate = true, center }) => {
  const history = useHistory();
  const avatarClassName = noAvatar ? "no-avatar" : "channel-avatar pointer"
  const containerClassName = center ? "video-info-container center" : "video-info-container"
  ...
  return (
    <Wrapper>
      ...
      <div className={containerClassName}>
        ...
        <div className={avatarClassName}>{isPngOrJpg()}</div>
      </div>
    </Wrapper>
  );
};
