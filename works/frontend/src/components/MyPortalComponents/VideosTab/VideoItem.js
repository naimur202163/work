...
const VideoItem = ({ isSelf, video, setSelectedVideo, setVideoId }) => {
  const { setShowMyPortal } = useContext(GlobalContext)
  const history = useHistory();
  const VIDEOOPTIONS1 = [
    { icon: <i class="fas fa-marker"></i>, text: "Edit Video" },
    { icon: <i class="fas fa-share-square"></i>, text: "Share Video" },
  ];
  const { userSettings } = useSelector((state) => state.profile);
  ...
  const isBadgeOrAvatar = () => {
    const image = !video.User.avatar
      ? userSettings.VisitorBadge.imgPath
      : video.User.avatar;
      ...
      <VideoItemStyledV2>
        ...
        <div className="metaInfo">
          ...
          <div className="metaInfo__right">
            <VideoOptions
              options={isSelf ? VIDEOOPTIONS1 : VIDEOOPTIONS2}
        ...
        <div className="length">
          <span>{toHHMMSS(parseInt(video.videoLength))}</span>
        </div>
      </VideoItemStyledV2>
    );
  }
  ...
  return (
    <VideoItemStyled>
      ...
      <div className="metaInfo">
        ...
        <div className="metaInfo__right">
          <VideoOptions options={isSelf ? VIDEOOPTIONS1 : VIDEOOPTIONS2} />
        </div>
      </div>
...
const VideoItemStyledV2 = styled.div`
  margin-bottom: 2rem;
  position: relative;
  cursor: pointer;
